...
if symbol and start_date < end_date:
    ...
    if data.empty:
        ...
        # Construct legend label for optimal interval
        interval_label = f'Optimal Interval [{lower_opt:.2%}, {upper_opt:.2%}] ({prob_opt:.2%})'

        # Figure 1: Histogram + PDF + Optimal Interval Shade
        fig1 = go.Figure()
        ...
        # Figure 2: Same base plot + Threshold Tail Shade
        fig2 = go.Figure()
